...
const MODULES: &[(&str, &str)] = &[
    ...
    (
        "assert/strict",
        include_str!("../../../runtime/polyfills/node/assert_strict.js"),
    ),
    (
        "util/types",
        include_str!("../../../runtime/polyfills/node/util_types.js"),
    ),
    (
        "path/posix",
        include_str!("../../../runtime/polyfills/node/path_posix.js"),
    ),
    (
        "path/win32",
        include_str!("../../../runtime/polyfills/node/path_win32.js"),
    ),
    (
        "stream/web",
        include_str!("../../../runtime/polyfills/node/stream_web.js"),
    ),
    (
        "stream/promises",
        include_str!("../../../runtime/polyfills/node/stream_promises.js"),
    ),
    (
        "stream/consumers",
        include_str!("../../../runtime/polyfills/node/stream_consumers.js"),
    ),
    (
        "diagnostics_channel",
        include_str!("../../../runtime/polyfills/node/diagnostics_channel.js"),
    ),
    (
        "http2",
        include_str!("../../../runtime/polyfills/node/http2.js"),
    ),
    (
        "readline",
        include_str!("../../../runtime/polyfills/node/readline.js"),
    ),
    (
        "readline/promises",
        include_str!("../../../runtime/polyfills/node/readline_promises.js"),
    ),
];
